...
The custom selection uses a **two-level drill-down** instead of a flat checkbox list, making it possible to navigate 199 individual modules across 6 categories.
